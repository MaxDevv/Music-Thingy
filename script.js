    ...
    function playRandomMP3() {
        ...
        if (modesFolder[modes.indexOf(mode)] == "all") {
            ...
            if (practiceType > 0.35) {
                ...
                techniqueExercises = [
                    ["Alternating Diagonal hand exercise"],
